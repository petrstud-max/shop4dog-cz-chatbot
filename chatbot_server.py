"""
Shop4Dog.cz AI Chatbot — webovy server.
Pouziva FastAPI + OpenAI GPT-4o + znalostni bazi o Shop4Dog.cz.
"""
...
def get_system_prompt() -> str:
    ...
    return f"""Jsi pratelsky a profesionalni zakaznicky asistent spolecnosti Shop4Dog.cz.
Odpovidas na otazky zakazniku o firme Shop4Dog.cz, jejich sluzbech, pobockach a kontaktech.
...
Pokud odpoved neznas, doporuc kontaktovat Shop4Dog.cz primo.
...
app = FastAPI(title="Shop4Dog.cz Chatbot")
